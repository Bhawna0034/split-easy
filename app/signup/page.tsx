        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-center overflow-hidden bg-[#f8f4ef] min-h-screen p-12">
            <div className="h-full bg-white rounded-sm max-w-[90%] px-6 py-12">
                ...
                <div className="mt-12 space-y-3">
                    ...
                    <h2 className="text-5xl font-bold text-[#28252a]">Create your account.</h2>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <Field>
                            ...
                            <div className="relative">
                                ...
                                <Input id="name" value={formData.name} onChange={(e) => handleChange("name", e.target.value)} placeholder="Rohan Kapoor"
                                    autoComplete="off" className={`border border-[#e4dfda] rounded-lg pl-11 py-3.5 pr-4 text-gray-600 placeholder-[#bbbbbc] outline-none transition focus:border-neutral-400 ${errors.name ? "border-red-400" : "border-[#e4dfda]"}`} />
                            </div>
                            {errors.name && (
            ...
            <div className="max-lg:hidden relative h-full w-full rounded-sm overflow-hidden">
                <Image src="/background-image.png" alt="SplitEasy app preview showing weekend" fill
                    priority className="object-fit" />
            </div>
